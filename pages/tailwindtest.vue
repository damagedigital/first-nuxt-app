    ...
    <div class="bg-indigo-900 px-4 py-4">
      <div class="md:max-w-6xl md:mx-auto md:flex md:items-center md:justify-between">
        <div class="flex justify-between items-center">
          <a href="#" class="inline-block py-2 text-white text-xl font-bold">Demopay</a>
        ...
        <div class="md:max-w-6xl md:mx-auto">
          <div class="md:flex md:flex-wrap">
            <div class="md:w-1/2 text-center md:text-left md:pt-16">
              ...
              >Simple payment platform for any service</h1>
              ...
              <div class="hidden md:block">
                ...
                >
                  ...
                  <div class="flex-1 p-6">
                    <h2 class="text-lg text-gray-700 font-bold mb-3">Popular Payments</h2>
                    <div class="flex mb-5">
